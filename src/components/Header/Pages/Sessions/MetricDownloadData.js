        ...
        <div className={classes.grids} style={{ padding: "50px" }}>
          ...
          <div style={{ marginTop: "25px" }}>
            ...
            <Plot
              data={[
                {
                  x: Secondsessiondata.download_data_usage_time,
                  y: Secondsessiondata.downloadddata_app_uage,
                  hovertemplate: "<b>%{text}</b>",
                  text: Secondsessiondata.download_data_app_deviation,
                  showlegend: false,
                  type: "scatter",
                  mode: "line",
                  type: "scatter",
  ...
  <TableContainer component={Paper} sx={{ boxShadow: "none" }}>
    ...
    >
      <TableRow sx={{ border: 0 }}>
        <TableCell align="right">{Secondsessiondata.download_data_usage_average}</TableCell>
        <TableCell align="right">{Secondsessiondata.cpu_cores_usage_average}</TableCell>
