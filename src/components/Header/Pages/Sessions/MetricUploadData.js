        ...
        <div className={classes.grids} style={{ padding: "50px" }}>
          ...
          <div style={{ marginTop: "25px" }}>
            ...
            <Plot
              data={[
                {
                  x: Secondsessiondata.upload_data_usage_time,
                  y: Secondsessiondata.uploaddata_app_usage,
                  hovertemplate: "<b>%{text}</b>",
                  text: Secondsessiondata.power_deviation,
                  showlegend: false,
                  type: "scatter",
                  mode: "line",
                  type: "scatter",
  ...
  <TableContainer component={Paper} sx={{ boxShadow: "none" }}>
    ...
    >
      <TableRow sx={{ border: 0 }}>
        <TableCell align="right">{Secondsessiondata.upload_data_usage_average}</TableCell>
