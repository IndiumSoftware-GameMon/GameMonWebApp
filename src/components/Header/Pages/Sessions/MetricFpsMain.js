        ...
        <div className={classes.grids} style={{ padding: "50px" }}>
          ...
          <div style={{ marginTop: "25px" }}>
            ...
            <Plot
              data={[
                {
                  x: Secondsessiondata.average_fps_app_usage_time,
                  y: Secondsessiondata.averagefps_app_usage,
                  hovertemplate: "<b>%{text}</b>",
                  text: Secondsessiondata.average_fps_app_deviation,
                  showlegend: false,
                  type: "scatter",
                  mode: "line",
                  type: "scatter",
              ...
              <TableContainer component={Paper} sx={{ boxShadow: "none" }}>
                ...
                >
                  <TableRow sx={{ border: 0 }}>
                    <TableCell align="right">{Secondsessiondata.average_fps_value}</TableCell>
