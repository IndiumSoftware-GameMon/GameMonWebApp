        ...
        <div className={classes.grids} style={{ padding: "50px" }}>
          ...
          <div style={{ marginTop: "25px" }}>
            ...
            <Plot
              data={[
                {
                  x: Secondsessiondata.memory_usage_time,
                  y: Secondsessiondata.avg_memory_usage,

                  hovertemplate: "<b>%{text}</b>",
                  text: Secondsessiondata.memory_deviation,
                  showlegend: false,
                  type: "scatter",
                  mode: "line",
                  type: "scatter",
  ...
  <TableContainer component={Paper} sx={{ boxShadow: "none" }}>
    ...
    >
      <TableRow sx={{ border: 0 }}>
        <TableCell align="right">{Secondsessiondata.memory_average_usage}</TableCell>
